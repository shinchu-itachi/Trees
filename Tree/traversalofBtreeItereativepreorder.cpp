...
void preorder( Tree * root ) {
   // here we have to maintiain the sequence like root left right so we have to follow this patter using stack
   // but to get in correct patter of root left right we must insert node into stack like root right left
   stack<Tree*> st;
