...
// here to print the postorder of the tree we have to maintain two stack one for input and second for output
// since we have to follow left right root for postorder
...
void postorder( Tree * root) {
   ...
   while ( !in.empty()) {
      ...
      if ( head->left) in.push(head ->left);
      if ( head->right) in.push(head -> right);
   }
